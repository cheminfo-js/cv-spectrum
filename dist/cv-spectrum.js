...
class Spectra {
  constructor(options = {}) {
    this.from = options.from === undefined ? 200 : options.from;
    this.to = options.to === undefined ? 400 : options.to;
    this.numberOfPoints = options.numberOfPoints === undefined ? 1024 : options.numberOfPoints;
